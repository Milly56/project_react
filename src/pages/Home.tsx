...
import homeAdicionarDark from "../assets/home_adiciona_dark.png";
import homeExcluirDark from "../assets/home_excluir_dark.png";
import homeListaDark from "../assets/home_lista_dark.png";
import homePesquisarDark from "../assets/home_pesquisar_dark.png";
import homeAtualizarDark from "../assets/home_atualizar_dark.png";
...
export default function Home() {
  ...
  useEffect(() => {
    const observer = new MutationObserver(() => {
      setTemaDark(document.documentElement.classList.contains("dark"));
    });
  ...
  const categorias = [
    {
      titulo: "adicionar livros a biblioteca digital",
      icon: temaDark ? homeAdicionarDark : homeAdicionar,
    },
    {
      titulo: "excluir livros da biblioteca digital",
      icon: temaDark ? homeExcluirDark : homeExcluir,
    },
    {
      titulo: "listar livros da biblioteca digital",
      icon: temaDark ? homeListaDark : homeLista,
    },
    {
      titulo: "pesquisar livros na biblioteca digital",
      icon: temaDark ? homePesquisarDark : homePesquisar,
    },
    {
      titulo: "atualizar livros da biblioteca digital",
      icon: temaDark ? homeAtualizarDark : homeAtualizar,
    },
  ];

  return (
    <div className="flex flex-col justify-center items-center bg-gray-100 dark:bg-[#1a1a1a] p-2 w-full overflow-x-hidden transition-colors">
      <div className="h-full rounded-2xl shadow-xl bg-[#678DB2] dark:bg-[#2a3d4f] w-full max-w-[1600px] flex flex-col relative overflow-hidden p-4 sm:p-6 transition-colors">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center gap-10 w-full">
          ...
          <div className="w-[220px] h-[300px] relative justify-center hidden lg:flex">
            <div className="w-56 h-90 bg-white/15 dark:bg-black/20 backdrop-blur-md border border-white/25 rounded-xl shadow-lg transition"></div>

            <div className="w-56 h-90 bg-white/15 dark:bg-black/20 backdrop-blur-md border border-white/25 rounded-xl shadow-lg absolute top-16 left-14 sm:left-20 flex items-center justify-center text-white transition">
              <p className="mx-4">
        ...
        <div className="flex flex-row items-center justify-center gap-2 pt-20 pb-6 w-full">
          <div className="w-full border border-[#74B7F6] dark:border-[#3d6c94] transition"></div>
