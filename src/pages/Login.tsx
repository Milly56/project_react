      ...
      <div className="relative grid grid-cols-1 lg:grid-cols-2 bg-white rounded-2xl shadow-xl overflow-hidden w-full max-w-[1200px] min-h-screen lg:min-h-[600px]">
        ...
        <div className="relative hidden lg:flex flex-col justify-center items-center text-white px-8 pt-8 pb-10 overflow-hidden bg-[url('src/assets/fundo.png')] bg-cover bg-center">
          ...
          <div className="flex items-end gap-6 w-full justify-center mt-8">
            <p className="text-[18px] leading-relaxed max-w-[200px] text-left mb-12">"A sua biblioteca, a qualquer hora e em qualquer lugar. Faça seu login."</p>
            <div className="relative flex justify-center items-center h-75 w-60 rounded-2xl overflow-hidden ">
              <img
                src="src/assets/moldura.png"
                alt="Moldura decorativa"
                className="absolute left-1/2 top-1/2 w-[130%] h-[150%] -translate-x-1/2 -translate-y-1/2 object-contain object-center rounded-2xl z-0"
              />
              <img
