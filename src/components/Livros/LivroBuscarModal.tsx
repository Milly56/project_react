        ...
        return (
            <div className="flex flex-col gap-4 w-full max-w-sm sm:max-w-md md:max-w-lg
                ...
                <button
                    ...
                    className="bg-[#5288BC] text-white p-3 sm:p-4 rounded-lg 
                ...
                {livroEncontrado && (
                    <div className="border rounded-lg p-4 sm:p-6 
                                    ...
                                    border-gray-300 dark:border-gray-600
                                    flex flex-col gap-3 sm:gap-4 text-sm sm:text-base">
                        
                        <p><strong>ID:</strong> {livroEncontrado.id}</p>
                        <p><strong>Título:</strong> {livroEncontrado.titulo}</p>
                        <p><strong>Categoria:</strong> {livroEncontrado.categoria}</p>
                        <p><strong>Quantidade:</strong> {livroEncontrado.quantidade}</p>
                        ...
                        <button
                            ...
                            className="p-2 sm:p-3 rounded-lg text-sm sm:text-base text-black dark:text-gray-900 
